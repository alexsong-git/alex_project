...
from data.rc_data  import chromedriver_path, url_resolution_portal
...
class Auto_Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data_twice = []
        self.path= '/Users/alex/PycharmProjects/Seel_Project/test_report/RC_login_resolution_portal.log'
